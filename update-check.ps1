...
$package += ,@('touchportal', 'https://www.touch-portal.com/downloads/TouchPortal_Setup_release.exe', 'A0B3DDB1B02116E5AC45CC415920509CC522AF26D61E7032CD2CAA8AEA593D03')
