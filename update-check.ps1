...
$package += ,@('backupstartmenulayout', 'https://www.sordum.org/files/download/backup-start-menu-layout/BackupSML.zip', 'AE7A72BE10603CC979900EE5A333AD531E50FCD0EA08427994E282FFAE061A3D')
