...
$package += ,@('hasleobackupsuite', 'https://www.easyuefi.com/backup-software/downloads/Hasleo_Backup_Suite_Free.exe', 'E18B0ED9C173AD2E9D57700EFF267BAE275B5D642917AC00F78AB95B73724BFD')
